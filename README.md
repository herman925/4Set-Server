...
- **User Guides**: Root-level guides for end users
  - `USER_GUIDE_CHECKING_SYSTEM.md` - Checking system usage guide
  - `USER_GUIDE_UPLOADER.md` - Upload interface guide
  - `USER_GUIDE_QUALTRICS_TGMD.md` - Qualtrics integration guide
  - `USER_GUIDE_CONFLICTS.md` - Data conflict resolution guide
...
**Note**: All technical documentation has been consolidated into the `/PRDs/` directory. Legacy references to `TEMP/` subdirectories should use the following paths:
